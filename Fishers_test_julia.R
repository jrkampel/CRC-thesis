...
# Load data 
likely_sporadic_data <- readxl::read_excel("~/download_dataset/likley_sporadic_data.xlsx")
likely_ls_data <- readxl::read_excel("~/download_dataset/likley_ls_data.xlsx")
allmuts2_CRC <- read_delim("~/download_dataset/allmuts2_crc_new.csv", 
                           delim = ",", escape_double = FALSE, trim_ws = TRUE)
mutation_data <- read.delim("~/download_dataset/coadread_tcga_pan_can_atlas_2018/data_mutations.txt", header = TRUE, sep = "\t")
...
cancer_gene_list <- read.delim("~/download_dataset/cancerGeneList.tsv")
